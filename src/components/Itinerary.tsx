...
const days = [
  ...
  },
  {
    day: 2,
    title: "兔仔島與尾道漫步",
    description: "善用新幹線極速前往三原，探訪被可愛兔子包圍的秘境，下午前往充滿懷舊風情的尾道。",
    alert: "放心去兔仔島！從廣島搭新幹線去三原轉車只需25分鐘，極快！建議將大型行李留在廣島市區酒店。",
    icon: RabbitIllustration,
    activities: [
      { time: "08:30", title: "廣島站出發 (搭新幹線!)", desc: "搭乘山陽新幹線 (Kodama/Sakura) 前往「三原站」(極速只需25分鐘，有機會搭中 Hello Kitty 新幹線！)，過對面月台轉乘 JR 吳線前往「忠海站」(約20分鐘)。" },
